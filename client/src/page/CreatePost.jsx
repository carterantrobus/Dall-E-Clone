  ...
  return (
    <section className='max-w-7xl mx-auto'>
      <div>
        ...
        <p className='mt-2 text-[#666e75] text-[14px] max-width-[500px]'>
          Generate imaginative and visually stunning images generated through DALL-E AI and share them with the community
        </p>
      </div>
